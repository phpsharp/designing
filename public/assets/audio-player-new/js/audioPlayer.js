! function($) {
    function initAudioPlayer() {
        ...
        function b() {
			console.log('b');
			console.log(w);
            var t = w.currentTime * parseFloat(100 / w.duration);
			console.log(t);
        ...
        function y(t) {
            ...
            var i = t.value;
			$("#slider").roundSlider("option", "value", i); 
			seekto = w.duration * parseFloat(i / 100);
			w.currentTime = seekto;			
			var x = w.readyState;
        }
        ...
        function CreateRoundSlider(t, i) {
			console.log("CreateRoundSlider");
            for (var e, s, n = 0; n < this.length; n++)
                if (e = this[n], s = $data(e, pluginName)) {
                    if ($isPlainObject(t)) 
					{
						console.log(t);
						"function" == typeof s.option ? s.option(t) : e.id && window[e.id] && "function" == typeof window[e.id].option && window[e.id].option(t);
						console.log('t---');
        ...
        $.fn[pluginName] = function(t) {
            ...
            _changeSliderValue: function(t, i) {
				...
				console.log('_changeSliderValue');
				console.log(t, i);
				...
				console.log('value', this.options.value);
            },
            ...
            _appendHiddenField: function() {
				console.log("_appendHandleField");
            ...
            _validateStartAngle: function() {
				console.log('_validateStartAngle');
            ...
            _analyzeModelValue: function() {
				console.log('_analyzeModelValue');
            ...
            _validateModelValue: function() {
				console.log('_validateModelValue');
